...
VideoStream.prototype.onSocketConnect = function(socket, request) {
  ...
  global.Logger && global.Logger.info(`node-rtsp-stream:: ${this.name}: New WebSocket Connection. (${this.wsServer.clients.size} total)`)

  socket.remoteAddress = request.connection.remoteAddress

  return socket.on("close", (code, message) => {
    global.Logger && global.Logger.info(`node-rtsp-stream:: ${this.name}: Disconnected WebSocket. (${this.wsServer.clients.size} total)`)
